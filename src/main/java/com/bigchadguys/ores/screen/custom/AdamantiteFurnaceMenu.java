...
public class AdamantiteFurnaceMenu extends AbstractContainerMenu {
    ...
    public AdamantiteFurnaceMenu(MenuType<?> type, int id, Inventory playerInventory,
                                 AdamantiteFurnaceBlockEntity blockEntity, Container container, ContainerData data) {
        super(type, id);
    ...
    private boolean isFuel(ItemStack stack) {
        return AdamantiteFurnaceBlockEntity.isFuel(stack);
    }
}
