...
@EventBusSubscriber(modid = JoesOres.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
public class DataGenerator {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        BlockTagsProvider blockTagsProvider = new ModBlockTagProvider(
                packOutput,
                lookupProvider,
                existingFileHelper
        );
        ...
        ModItemTagsProvider itemTagsProvider = new ModItemTagsProvider(
                packOutput,
                lookupProvider,
                blockTagsProvider,
                existingFileHelper
